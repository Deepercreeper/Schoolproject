...
public class Block
{
	...
	public static final Block						STONE						= new Block(1, new int[] { 0xB89040, 0xC0C0C0, 0xB89040, 0x2A7CE0, 0x5000DB, 0xB89040, 0xB89040 });
	public static final Block						BRICK						= new Block(2, new int[] { 0xB06000, 0x727272, 0xB06000, 0x014EB2, 0x014EB2, 0xB06000, 0xB06000 }).setDestroyable(AIR);
	public static final Block						OPENED						= new Block(3, new int[] { 0xC03010, 0xC03011, 0xC03010, 0xC03012, 0xC03012, 0xC03010, 0xC03010 });
	public static final Block						QUESTION					= new Block(4, new int[] { 0xD8B018, 0xFFD800, 0xD8B018, 0x14466D, 0x14466D, 0xD8B018, 0xD8B018 }).setDestroyable(OPENED)
																						.setItem(255, Item.SUPER_BANANA).setItem(254, Item.BANANA).setItem(253, Item.HEART);
	public static final Block						GROUND_TOP_LEFT				= new Block(5, new int[] { 0x00E000, 0x93FFFF, 0xFFA359, 0x3D2C77, 0x564E75, 0x00E096, 0x00AA71 });
	public static final Block						GROUND_TOP					= new Block(6, new int[] { 0x00BA00, 0x00FFFF, 0xFF7400, 0x291D4F, 0x39334C, 0x00BA96, 0x00846A });
	public static final Block						GROUND_TOP_RIGHT			= new Block(7, new int[] { 0x009300, 0x00D3D3, 0xB75200, 0x1D1438, 0x272335, 0x009396, 0x005F60 });
	public static final Block						GROUND_STOP_LEFT			= new Block(8, new int[] { 0x8CB848, 0x8EF4D5, 0x87612D, 0x3D4677, 0x606375, 0x8CB8DE, 0x6D8FAA });
	public static final Block						GROUND_STOP_RIGHT			= new Block(9, new int[] { 0x73963C, 0x00DDD3, 0x704A00, 0x1D2338, 0x2B2E35, 0x7396D2, 0x56729E });
	public static final Block						GROUND_LEFT					= new Block(10, new int[] { 0xF0B848, 0xAD7854, 0x87512D, 0x1D0077, 0x362375, 0xF0B8DE, 0x8CB8DE });
	public static final Block						GROUND_MIDDLE				= new Block(11, new int[] { 0xD3A23F, 0xAF4600, 0x873600, 0x140050, 0x25174F, 0xD3A2D5, 0x6FA2D5 });
	public static final Block						GROUND_RIGHT				= new Block(12, new int[] { 0xAD8434, 0x993D00, 0x702C00, 0x0D0035, 0x170F33, 0xAD84CA, 0x4984CA });
	public static final Block						GROUND_BOTTOM_LEFT			= new Block(13, new int[] { 0xA07931, 0xAD9354, 0xBC5F3A, 0x25234C, 0x393849, 0xA079C7, 0x3C79C7 });
	public static final Block						GROUND_BOTTOM				= new Block(14, new int[] { 0x99722F, 0xAF6D00, 0xBE3600, 0x06004F, 0x1A164C, 0x9972C5, 0x3572C5 });
	public static final Block						GROUND_BOTTOM_RIGHT			= new Block(15, new int[] { 0x936C2D, 0x995900, 0xA02D00, 0x04003D, 0x13113A, 0x936CC3, 0x2F6CC3 });
	public static final Block						GROUND_BOTTOM_STOP_LEFT		= new Block(16, new int[] { 0xB6B848, 0x997F00, 0xA05500, 0x04273D, 0x152C3A, 0xB6B8DE, 0x52B8DE });
	public static final Block						GROUND_BOTTOM_STOP_RIGHT	= new Block(17, new int[] { 0xABAD45, 0x7F6A00, 0xBC803A, 0x253E4C, 0x3A4449, 0xABADDB, 0x47ADDB });
	...
	public static final Block						PLATFORM					= new Block(33, new int[] { 0x74FF8C, 0x74FF8C, 0x74FF8C, 0x88FFFF, 0x88A3FF, 0x74FF8C, 0x74FF8C }).setSolidSide(Direction.TOP);
