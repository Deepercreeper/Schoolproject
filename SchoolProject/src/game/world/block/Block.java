...
public class Block
{
	...
	public static final Block					STONE						= new Block(1, new int[] { 0xB89040, 0xC0C0C0 });
	public static final Block					BRICK						= new Block(2, new int[] { 0xB06000, 0x727272 }).setDestroyable(AIR);
	public static final Block					OPENED						= new Block(3, new int[] { 0xC03010, 0xC03011 });
	public static final Block					QUESTION					= new Block(4, new int[] { 0xD8B018, 0xFFD800 }).setDestroyable(OPENED).setItem(Item.SUPER_BANANA);
	public static final Block					GROUND_TOP_LEFT				= new Block(5, new int[] { 0x00E000, 0x93FFFF });
	public static final Block					GROUND_TOP					= new Block(6, new int[] { 0x00BA00, 0x00FFFF });
	public static final Block					GROUND_TOP_RIGHT			= new Block(7, new int[] { 0x009300, 0x00D3D3 });
	public static final Block					GROUND_STOP_LEFT			= new Block(8, new int[] { 0x8CB848, 0x8EF4D5 });
	public static final Block					GROUND_STOP_RIGHT			= new Block(9, new int[] { 0x73963C, 0x00DDD3 });
	public static final Block					GROUND_LEFT					= new Block(10, new int[] { 0xF0B848, 0xAD7854 });
	public static final Block					GROUND_MIDDLE				= new Block(11, new int[] { 0xD3A23F, 0xAF4600 });
	public static final Block					GROUND_RIGHT				= new Block(12, new int[] { 0xAD8434, 0x993D00 });
	public static final Block					GROUND_BOTTOM_LEFT			= new Block(13, new int[] { 0xA07931, 0xAD9354 });
	public static final Block					GROUND_BOTTOM				= new Block(14, new int[] { 0x99722F, 0xAF6D00 });
	public static final Block					GROUND_BOTTOM_RIGHT			= new Block(15, new int[] { 0x936C2D, 0x995900 });
	public static final Block					GROUND_BOTTOM_STOP_LEFT		= new Block(16, new int[] { 0xB6B848, 0x997F00 });
	public static final Block					GROUND_BOTTOM_STOP_RIGHT	= new Block(17, new int[] { 0xABAD45, 0x7F6A00 });
